...
# $(OBJS): $(SRCS)
# -include $(DEPENDS)
$(foreach SRC,$(SRCS),$(eval $(filter-out \,$(shell $(CC) $(CPPFLAGS) -MM $(SRC)))))

test: $(TARGET)
	@./$<

depends:
	$(CC) $(CPPFLAGS) -MM $(SRCS) > $(DEPENDS)

asm:
	$(CC) $(CFLAGS) $(CPPFLAGS) -S --verbose-asm $(SRCS)

syntax:
	$(CC) $(WARNING_CFLAGS) $(CPPFLAGS) -fsyntax-only $(SRCS)
